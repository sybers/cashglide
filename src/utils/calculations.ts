...
export function calculateInvestmentStats(
  ...
  const currentPercentage = totalRevenue > 0 ? (totalInvestments / totalRevenue) * 100 : 0;
  ...
  const possiblePercentage = totalRevenue > 0 ? (availableForInvestment / totalRevenue) * 100 : 0;
