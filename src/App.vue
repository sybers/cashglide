      ...
      <div class="mb-8 p-5 bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-slate-600">
          <div class="flex gap-3">
            <div class="shrink-0 w-8 h-8 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-bold">1</div>
            <div>
              <p class="font-medium text-slate-700">Add your income</p>
              <p class="mt-1 text-slate-500">Enter your revenue sources like salary, freelancing, or side projects.</p>
            </div>
          </div>
          <div class="flex gap-3">
            <div class="shrink-0 w-8 h-8 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center font-bold">2</div>
            <div>
              <p class="font-medium text-slate-700">Track investments & expenses</p>
              <p class="mt-1 text-slate-500">Categorize your spending and investments to see where your money goes.</p>
            </div>
          </div>
          <div class="flex gap-3">
            <div class="shrink-0 w-8 h-8 rounded-full bg-violet-100 text-violet-600 flex items-center justify-center font-bold">3</div>
            <div>
              <p class="font-medium text-slate-700">Visualize your cashflow</p>
              <p class="mt-1 text-slate-500">See your financial flow in an interactive diagram and discover optimization opportunities.</p>
            </div>
          </div>
        </div>
        <p class="mt-4 text-xs text-slate-400">Tip: Click on any value to edit it directly. Your data is saved locally in your browser.</p>
      </div>
    ...
    <footer class="bg-white/80 backdrop-blur-sm border-t border-slate-200/50 mt-auto">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <p class="text-center text-sm text-slate-500">
          Made with ❤️ by <a href="https://github.com/sybers" target="_blank" rel="noopener noreferrer" class="font-medium text-slate-700 hover:text-sky-500 transition-colors">sybers</a>
        </p>
      </div>
    </footer>
  </div>
